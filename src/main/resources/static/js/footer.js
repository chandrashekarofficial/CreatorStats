(function(){
  ...
  function getToken(){
    return localStorage.getItem("token") || localStorage.getItem("jwt") || localStorage.getItem("accessToken") || localStorage.getItem("authToken");
  }
  ...
  function addAuthMenu(){
    ...
    wrap.innerHTML='<button type="button" class="creatorstats-profile-btn" aria-label="Open profile menu" aria-expanded="false">C</button><div class="creatorstats-profile-menu" role="menu"><div class="creatorstats-profile-head"><strong>CreatorStats</strong><span>Account</span></div><a href="/analytics.html" role="menuitem">Your Channel</a><a href="/favorites.html" role="menuitem">Favorites</a><a href="/settings.html" role="menuitem">Settings</a><a href="/contact.html?subject=Support" role="menuitem">Help</a><a href="/contact.html?subject=Feedback" role="menuitem">Give Feedback</a><button type="button" class="creatorstats-logout" role="menuitem">Logout</button></div>';
